...
class help(commands.Cog):
    ...
    async def info(self, ctx):
        ...
        embed.add_field(name='Bug report and support:', value= """To give a suggestion and report a bug, typo, issue or anything else DM the bot.
☑ You will get a response, as long as your DMs aren't closed to the server.
_ _
